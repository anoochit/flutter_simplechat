...
class _ChatPageState extends State<ChatPage> {
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      ...
                      if (textInputController.text.trim() != "") {
                        sendMessage(uid: (appData.userUid.toString()), peerId: widget.peerId, type: 0, content: textInputController.text.trim(), timestamp: DateTime.now().millisecondsSinceEpoch);
  ...
  sendMessage({required String uid, required String peerId, required int type, required int timestamp, required String content}) {
